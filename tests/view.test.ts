...
describe('what compact does — and what it deliberately does not', () => {
  ...
  it('keeps EVERY other field, because nothing here knows which FlightAware fields matter', () => {
    ...
    const record = {
      ident: 'N12345', registration: 'N12345', type: 'C172', owner: 'Acme',
      aircraft_type: 'C172', blocked: false, cancelled: null,
  ...
  it('keeps a page URL', () => {
    const d = { link: 'https://flightaware.com/live/flight/N12345' };
